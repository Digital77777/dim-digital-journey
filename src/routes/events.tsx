...
export const Route = createFileRoute("/events")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://dim-digital-journey.lovable.app/events" },
      { property: "og:type", content: "website" },
    ],
    links: [{ rel: "canonical", href: "https://dim-digital-journey.lovable.app/events" }],
    scripts: [breadcrumbLd("/events", "DIM Events and Workshops")],
  }),
