...
export const Route = createFileRoute("/creator")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://dim-digital-journey.lovable.app/creator" },
      { property: "og:type", content: "website" },
    ],
    links: [{ rel: "canonical", href: "https://dim-digital-journey.lovable.app/creator" }],
    scripts: [breadcrumbLd("/creator", "Creator on DIM")],
  }),
